...
::: {.shot}
![A q2-preview document. The comment on the right ("nice") was added from the preview pane and lives in the source as `[>> nice]`.](images/get-started/03b-preview-editing.png)
:::
