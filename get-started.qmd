...
Click the **share** icon next to the project name at the top of the file panel. The **Share project** dialog shows a **Shareable link**; click **Copy link** and send it to a colleague.
...
Here you can group projects into **collections**: folders for your own view of the projects page. Click **＋ New collection**, name it ("Team meetings", "Q4 planning"), and it appears as a section. Projects not in any collection sit under **Everything else**.
