...
Here you can group projects into **collections**: folders for your own view of the projects page. Click **＋ New collection** and give it a name.

::: {.shot .narrow}
![Naming a new collection.](images/get-started/05b-new-collection.png)
:::

The new collection appears as a section at the top of the page, empty. Projects that are not in any collection sit under **Everything else**.

::: {.shot}
![An empty collection above the Everything else list. The project row on the right has three buttons: peek, fork, and the ⋯ menu.](images/get-started/05c-empty-collection.png)
:::

To move a project into the collection, drag its row onto the collection heading, or open the project's **⋯** menu and choose **Add to collection**. Move it between collections the same way. Collections change only how the page is arranged for you; they do not change the project or who it is shared with.
